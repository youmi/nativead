...
@implementation UMSPSimulateIDFA
...
void UMMD5_16(NSString *source, unsigned char *ret){
...
+ (NSString *)createSimulateIDFA{
    ...
    UMMD5_16(fingerPrintUnstablePart,fingerPrintUnstablePartMD5);
    
    unsigned char fingerPrintStablePartMD5[CC_MD5_DIGEST_LENGTH/2];
    UMMD5_16(fingerPrintStablePart,fingerPrintStablePartMD5);
