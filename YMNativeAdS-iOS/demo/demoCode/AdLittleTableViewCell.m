...
@interface AdLittleTableViewCell()
...
@implementation AdLittleTableViewCell
...
//        self.adSloganLb.backgroundColor = [UIColor redColor];
        self.adSloganLb.font = [UIFont systemFontOfSize:18];
...
//        self.adImgV.layer.masksToBounds = YES;
        ...
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-16-[_adSloganLb]-15-[_adImgV(100)]-10-|"
                                                                                 options:0
                                                                                 metrics:@{@"width":@(0)}
                                                                                   views:NSDictionaryOfVariableBindings(_adSloganLb,_adImgV)]];
        
        
        self.adImgV.translatesAutoresizingMaskIntoConstraints = NO;
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-9-[_adImgV(imgvheight)]"
                                                                                 options:0
        ...
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-5.5-[_adSloganLb]-16-[_adTip(height)]-13-|"
                                                                                 options:0
                                                                                 metrics:@{@"height":@(14)}
                                                                                   views:NSDictionaryOfVariableBindings(_adTip,_adSloganLb)]];
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-16-[_adTip(width)]-15-|"
                                                                                 options:0
                                                                                 metrics:@{@"width":@(27)}
